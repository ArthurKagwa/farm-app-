...
class Animal(models.Model):
    ...
    mother=models.ForeignKey('Animal',on_delete=models.CASCADE, related_name='mother_of')
    father=models.ForeignKey('Animal',on_delete=models.CASCADE, related_name='father_of')
...
class Medical(models.Model):
    animal_no=models.ForeignKey('Animal',on_delete=models.CASCADE)
...
class Task(models.Model):
    ...
    task_staff=models.ForeignKey('Staff',on_delete=models.CASCADE)
    task_animal=models.ForeignKey('Animal',on_delete=models.CASCADE,related_name='task_animal',null=True)
...
class Event(models.Model):
    ...
    event_staff=models.ForeignKey('Staff',on_delete=models.CASCADE)
    event_animal_type=models.ForeignKey('Type',on_delete=models.CASCADE,related_name='event_animal_type',null=True)
...
class Task_log(models.Model):
    ...
    task_log_staff=models.ForeignKey('Staff',on_delete=models.CASCADE)
    task_log_task=models.ForeignKey('Task',on_delete=models.CASCADE)
